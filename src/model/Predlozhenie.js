...
/*        async rebalance(){
          ...
          if (za.length) {
            ...
            this.totalZa = +zaCountAsArray[0].count
          }
          else {
            this.totalZa = 0
          }
          ...
          if (protiv.length) {
            ...
            this.totalProtiv = +protivCountAsArray[0].count
          }
          else {
            this.totalProtiv = 0
          }
